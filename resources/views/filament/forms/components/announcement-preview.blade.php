...
<div class="w-full max-w-[1100px] mx-auto overflow-hidden rounded-2xl border border-slate-700/80 shadow-2xl bg-slate-950 relative"
    ...
    @if($imgUrl)
        <!-- Case 1: Görsel VARSA -> Yalnızca Görsel Önizlemesi (Başlık & Mesaj Kutusu Yok) -->
    ...
    @else
        <!-- Case 2: Görsel YOKSA -> Sade 16:9 Arka Planda Başlık + (Varsa) Kısa Mesaj -->
